		   ...
		   <div class="box_wrapper"><h1>Car Brands </h1></div>
			<div class="section group">
				...
				<div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="toyota.php" title="Your choice is our pride!" class="button">cars<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="audi.php" title="Your choice is our pride!" class="button">cars<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="bmw.php" title="Your choice is our pride!" class="button">cars<span></span></a></div>
				</div>
				 ...
				 <div class="col_1_of_4 span_1_of_4">
					...
					<div class="Details">
				     <a href="chervolet.php" title="Your choice is our pride!" class="button">cars<span></span></a></div>
				</div>
