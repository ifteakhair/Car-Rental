...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Audi Q7 : (82.07 Lakh*)</h1></div>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    Audi India has launched the petrol-powered Q7 40 TFSI in the country. The company has launched it in two trim levels - Premium Plus and Technology. While the former is priced at Bdt 82.07 lakh, the latter will cost you Rs 74.43 lakh (both prices, ex-showroom).
Both variants are powered by the same 2.0-litre, turbocharged petrol engine.
                                </td>
                            </tr>
                        </tbody>
                    </table>
	   ...
	   <div class="footer-top">
				...
				<div class="col_1_of_5 span_1_of_5">
					<div class="footer-grid twitts">
						...
						<span>support.amirulscarshowroom@gmail.com</span>
					</div>
				</div>
				<div class="clear"></div>
		</div>
