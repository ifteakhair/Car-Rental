...
<div class="header-bottom">
	<div class="wrap">
		<div class="single">
				<div class="box_wrapper"><h1>Mitsubishi Lancer : (Bdt  9 Lakh*)</h1></div>
                    ...
                    <table class="table table-bordered table-responsive table-striped table-hover table-condensed">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                  Mitsubishi Lancer is a luxurious sedan model which is packed with an array of advanced features. Mitsubishi Lancer is a stylish car which is loaded with lots of styling features at both exteriors and interiors of the car.
                                </td>
                            </tr>
                        </tbody>
            </table>
